...
public class GdkRequestTest {
    ...
    private static final byte[]         gdkRequest_spin = rLoader.getResourceAsBytes("com/cwh/sample/resources/gdkRequest_spin.xml");
    private static final byte[]         gdkRequest_init = rLoader.getResourceAsBytes("com/cwh/sample/resources/gdkRequest_init.xml");
    ...
    public void testParseRequest_spinReq() {
        try {
            ...
            assertEquals(10,    gdkRequest.getPersistentState().getNumBonusSymbols().intValue());
            ...
            assertEquals(5,     ((SpinGameRequest)gdkRequest.getGameRequest()).getCreditsPerLine().intValue());
        } catch(Throwable t) {
            t.printStackTrace();
            fail();
        }
