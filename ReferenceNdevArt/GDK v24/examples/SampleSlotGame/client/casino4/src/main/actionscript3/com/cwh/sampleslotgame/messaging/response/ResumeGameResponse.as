package com.cwh.sampleslotgame.messaging.response {
    ...
    import com.cwh.debug.lcolog.LCOLog;
    ...
    public class ResumeGameResponse {
        ...
        private var creditValue:Number;
        private var creditsPerLine:uint;

        public function ResumeGameResponse ( responseData:XML ) {
            ...
            creditValue = Number(responseData.msgdata.initialWager.@coinValue);

            creditsPerLine = uint(responseData.msgdata.initialWager.@creditsPerLine);
        }
