package com.cwh.WhiteBuffalo.tasks.microtask.task.anticipation
{
	
	import ingenuity.casino.slotgame.tasks.microtask.task.anticipation.MicrotaskBaseGameAnticipationScatter;
	
	public class MicrotaskBaseGameAnticipationScatterWhiteBuffalo extends MicrotaskBaseGameAnticipationScatter
	{
