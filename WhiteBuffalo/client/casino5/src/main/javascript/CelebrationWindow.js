 ...
 // celebrationWindowIntroData.position.y=json.reels.y;
  ...
  //  banner.visible = false;
    ...
    instance.showFreeSpinIntro = function(numFreeSpinsWon){
        ...
        tfFsWon2.text = 8;
        tfFsWonShadow2.text = 8;
        tfFsWon3.text = langFile.freespin_intro_2;
        tfFsWonShadow3.text = langFile.freespin_intro_2;
        tfFsWon5.text = numFreeSpinsWon/8;
        tfFsWonShadow5.text = numFreeSpinsWon/8;
        tfFsWon6.text =langFile.freespin_intro_3;
        tfFsWonShadow6.text = langFile.freespin_intro_3;
        tfFsWon7.text = numFreeSpinsWon;
        tfFsWonShadow7.text = numFreeSpinsWon;
        tfFsWon8.text =  langFile.freespin_intro_2;
        tfFsWonShadow8.text = langFile.freespin_intro_2;
