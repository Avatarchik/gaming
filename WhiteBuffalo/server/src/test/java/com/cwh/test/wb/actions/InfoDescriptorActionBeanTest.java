...
import com.cwh.wb.actions.InfoDescriptorActionBean;
...
public class InfoDescriptorActionBeanTest extends BaseActionBeanTestMock {
    ...
    public void testProcessInfoGuideRequest() {
        try {
            ...
            assertTrue(actionResponse.contains("gameId=\"712\""));
            assertTrue(actionResponse.contains("displayGameName=\"Legend of the White Buffalo\""));
