...
public class MonarchSunREFreeSpinsReelsConfig implements REReelsConfig {
	...
	static {
        ...
        getReels().get(MonarchSunRTP.RTP_92).put(1, Arrays.asList(
                ...
                MonarchSunConfig.SYMBOL_L2, MonarchSunConfig.SYMBOL_H2, MonarchSunConfig.SYMBOL_H2,
                MonarchSunConfig.SYMBOL_H2, MonarchSunConfig.SYMBOL_L1, MonarchSunConfig.SYMBOL_L1,
                MonarchSunConfig.SYMBOL_L3));
        getReels().get(MonarchSunRTP.RTP_92).put(2, Arrays.asList(
                MonarchSunConfig.SYMBOL_WW, MonarchSunConfig.SYMBOL_H2, MonarchSunConfig.SYMBOL_WW,
                MonarchSunConfig.SYMBOL_WW, MonarchSunConfig.SYMBOL_H2, MonarchSunConfig.SYMBOL_L4,
                MonarchSunConfig.SYMBOL_L2, MonarchSunConfig.SYMBOL_H2, MonarchSunConfig.SYMBOL_H2,
                MonarchSunConfig.SYMBOL_L3));
        /*REEL 3 NOT REQUIRED*/
		getReels().get(MonarchSunRTP.RTP_92).put(4, Arrays.asList(
                MonarchSunConfig.SYMBOL_WW, MonarchSunConfig.SYMBOL_H2, MonarchSunConfig.SYMBOL_WW,
                MonarchSunConfig.SYMBOL_WW, MonarchSunConfig.SYMBOL_L1, MonarchSunConfig.SYMBOL_H2,
                MonarchSunConfig.SYMBOL_L2, MonarchSunConfig.SYMBOL_H2, MonarchSunConfig.SYMBOL_L1,
                MonarchSunConfig.SYMBOL_H2));
		getReels().get(MonarchSunRTP.RTP_92).put(5, Arrays.asList(
                MonarchSunConfig.SYMBOL_H2, MonarchSunConfig.SYMBOL_H2, MonarchSunConfig.SYMBOL_L2,
                MonarchSunConfig.SYMBOL_H2, MonarchSunConfig.SYMBOL_L1, MonarchSunConfig.SYMBOL_L4,
                MonarchSunConfig.SYMBOL_H2, MonarchSunConfig.SYMBOL_L1, MonarchSunConfig.SYMBOL_H2,
                MonarchSunConfig.SYMBOL_H2));
		...
		weights.addAll(Arrays.asList(10, 5, 5, 5, 50, 50, 50, 35, 50, 50));
	}
	...
	public List<String> getPattern(Object level, int pos) {
        ...
        //pattern.add(reel(level, 3).get(realPos));//Not required
