...
package   com.cwh.test.monarchsun.model;
...
public class GdkRequestTest {
    ...
    private static final byte[]         gdkRequest_spin = rLoader.getResourceAsBytes("com/cwh/test/monarchsun/resources/gdkRequest_spin.xml");
    private static final byte[]         gdkRequest_init = rLoader.getResourceAsBytes("com/cwh/test/monarchsun/resources/gdkRequest_init.xml");
