package com.cwh.MonarchSun.register
{
	...
	import com.cwh.MonarchSun.ui.mediator.freegame.MediatorFreeGameCounterMonarchSun;
	import com.cwh.MonarchSun.ui.mediator.freegame.MediatorFreegameIntroPopupMonarchSun;
	import com.cwh.MonarchSun.ui.mediator.freegame.MediatorFreegameOutroPopupMonarchSun;
	import com.cwh.MonarchSun.ui.mediator.meter.MediatorBetLineMeterMonarchSun;
	import com.cwh.MonarchSun.ui.view.freegame.ViewFreeGameCounterMonarchSun;
	import com.cwh.MonarchSun.ui.view.freegame.ViewFreeGameIntroPopupMonarchSun;
	...
	public class RegisterMediator
	{
		...
		private function registerConsoleMediator () : void
		{
			...
			_mediator.registerMediator ( MediatorKeyConsole.LINE_BET_METER , MediatorBetLineMeterMonarchSun , ViewBetLineMeter , clip );
			...
			_mediator.registerMediator ( MediatorKeyCJ.LINE_BET_METER, MediatorBetLineMeterMonarchSun , ViewBetLineMeter , settingClip );
		...
		private function registerFreeGame () : void
		{
			...
			_mediator.registerMediator ( MediatorKeyFeatureUI.FREEGAME_INTRO_SCREEN , MediatorFreegameIntroPopupMonarchSun, ViewFreeGameIntroPopupMonarchSun , intropopup ) ;
			
			
			var outropopup : MovieClip = _component.getComponent ( GameScreens.FREE_GAME_OUTRO_POPUP ) as MovieClip ; 
			_mediator.registerMediator ( MediatorKeyFeatureUI.FREEGAME_OUTRO_SCREEN , MediatorFreegameOutroPopupMonarchSun , ViewFreeGameOutroPopupCJ , outropopup ) ;
			...
			_mediator.registerMediator ( MediatorKeyConsole.FREEGAME_COUNTER , MediatorFreeGameCounterMonarchSun , ViewFreeGameCounterMonarchSun , winmeter ) ;
